    ...
    <div className={styles.desktop}>
      <div className={styles.tv2}>
        ...
        <div className={styles.rSide}>
          ...
          <img className={styles.towerIcon} alt="" src="/tower1.svg" />
          <div className={styles.target}>
            <div className={styles.red}>
              <div className={styles.target1} />
              <img className={styles.targetIcon} alt="" src="/target1.svg" />
            </div>
        ...
        <img className={styles.lSideIcon} alt="" src="/l-side1.svg" />
